...
HD_PWD='/home/hsianch/test_MSPM/test_MSPM.runs/fifo_wrapper_infill_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_wrapper_infill.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_wrapper_infill.tcl
