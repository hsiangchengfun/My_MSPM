...
HD_PWD='/home/hsianch/test_MSPM/test_MSPM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log client_epig_shim.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source client_epig_shim.tcl
