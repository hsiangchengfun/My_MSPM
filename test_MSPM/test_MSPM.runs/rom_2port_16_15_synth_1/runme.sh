...
HD_PWD='/home/hsianch/test_MSPM/test_MSPM.runs/rom_2port_16_15_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_2port_16_15.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_2port_16_15.tcl
