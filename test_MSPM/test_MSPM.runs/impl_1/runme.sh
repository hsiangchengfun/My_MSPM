...
HD_PWD='/home/hsianch/test_MSPM/test_MSPM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log client_epig_shim.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source client_epig_shim.tcl -notrace
