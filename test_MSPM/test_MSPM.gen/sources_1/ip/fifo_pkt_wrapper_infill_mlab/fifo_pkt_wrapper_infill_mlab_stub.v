...
// Command     : write_verilog -force -mode synth_stub -rename_top fifo_pkt_wrapper_infill_mlab -prefix
//               fifo_pkt_wrapper_infill_mlab_ fifo_wrapper_infill_stub.v
...
module fifo_pkt_wrapper_infill_mlab(clk, rst, din, wr_en, rd_en, dout, full, empty, valid)
