...
// Command     : write_verilog -force -mode synth_stub -rename_top dc_fifo_wrapper_infill_mlab -prefix
//               dc_fifo_wrapper_infill_mlab_ dc_fifo_wrapper_infill_mlab_stub.v
...
module dc_fifo_wrapper_infill_mlab(rst, wr_clk, rd_clk, din, wr_en, rd_en, dout, full, 
  empty, valid)
