...
`timescale 1 ps / 1 ps
`include "../self_modules/dc_fifo_wrapper_infill.sv"
`include "../self_modules/dc_fifo_wrapper_infill_mlab.sv"
`include "../self_modules/fifo_wrapper_infill.sv"
`include "../self_modules/fifo_wrapper_infill_mlab.sv"
`include "../self_modules/fifo_pkt_wrapper_infill.sv"
`include "../self_modules/fifo_pkt_wrapper_infill_mlab.sv"
    ...
    //single clock
        ...
        if(MEM_TYPE=="M20K")begin
            ...
            fifo_pkt_wrapper_infill_mlab #(
                .SYMBOLS_PER_BEAT(SYMBOLS_PER_BEAT),//64
                .BITS_PER_SYMBOL(BITS_PER_SYMBOL),//8
                .FIFO_DEPTH(FIFO_DEPTH),//512
                .USE_PACKETS(1)
            )
            sc_pkt_fifo_mlab (
                .clk               (in_clk),
